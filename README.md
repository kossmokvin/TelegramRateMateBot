# About the Project
 [@RateMateBot](https://t.me/RateMateBot/) - is a Telegram Bot and related Telegram Mini App which allow users to rate existed channels, groups, bots and leave public or anonymous reviews, while the Mini App shows the average rating and all community reviews.
